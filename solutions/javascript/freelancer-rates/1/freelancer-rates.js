...
export function daysInBudget(budget, ratePerHour) {
  // number of days they could work till the budget is exhausted
...
export function priceWithMonthlyDiscount(ratePerHour, numDays, discount) {
  ...
  */
  ...
  const discountedMonthTotal = fullMonths * monthlyRate * (1-discount);
  const remainingDaysTotal = ratePerHour * remainingDays * hoursPerDay;

  return Math.ceil(discountedMonthTotal + remainingDaysTotal)
